...
import com.example.test.service.login.SecurityService;
import com.example.test.service.login.AdminService;
...
public class AdminController {
    ...
    public String registration(@ModelAttribute("account") Admin adminForm, BindingResult bindingResult, Model model) {
